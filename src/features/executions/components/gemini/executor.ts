...
import { GeminiModelName } from "@/features/executions/components/gemini/dialog";
...
export const geminiExecutor: NodeExecutor<GeminiData> = async ({
  ...
  // console.log("geminiExecutor/", { data, nodeId, context, step });
  // emit loading event
  await publish(
